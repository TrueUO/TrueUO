...
namespace Server
{
	...
	public class Item : IEntity, IHued, IComparable<Item>, ISerializable, ISpawnable
	{
		...
		private void VerifyCompactInfo()
		{
			...
			bool isValid = info.m_Name != null || info.m_Items != null || info.m_Bounce != null || info.m_HeldBy != null || info.m_BlessedFor != null ||
		...
		private static bool _ScissorCopyLootType;
		public static bool ScissorCopyLootType { get => _ScissorCopyLootType; set => _ScissorCopyLootType = value; }
