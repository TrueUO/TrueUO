...
namespace Server
{
    public class Loot
    {
        ...
        private static readonly Type[] m_SARangedWeaponTypes =
        {
        ...
        private static readonly Type[] m_MLRangedWeaponTypes =
        {
		...
		private static readonly Type[] m_SEHatTypes =
        {
        ...
        private static readonly Type[] m_SERangedWeaponTypes =
        {
            typeof(Yumi)
        };
        ...
        private static readonly Type[] m_NecroRegTypes =
        {
        ...
        private static readonly Type[] m_MysticRegTypes =
        {
        ...
        private static readonly Type[] m_SEInstrumentTypes =
        {
            typeof(BambooFlute)
        };
        ...
        private static readonly Type[] m_InstrumentTypes =
        {
        ...
        {
            typeof(ClumsyWand), typeof(FeebleWand), typeof(ManaDrainWand), typeof(WeaknessWand)
        };
