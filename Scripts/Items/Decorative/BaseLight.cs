...
namespace Server.Items
{
    public abstract class BaseLight : Item, ICraftable, IResource, IQuality, ISecurable
    {
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public bool PlayerConstructed { get => _PlayerConstructed; set { _PlayerConstructed = value; InvalidateProperties(); } }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public bool BurntOut { get => m_BurntOut; set => m_BurntOut = value; }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool Protected { get => m_Protected; set => m_Protected = value; }
