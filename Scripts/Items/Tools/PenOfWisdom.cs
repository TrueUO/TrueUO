...
namespace Server.Items
{
    ...
    public class PenOfWisdomGump : Gump
    {
            ...
            : base(50, 50)
        {
            ...
            AddHtmlLocalized(7, 50, 380, 53, 1115428, $"@{MarkScrollAmount}@{RuneAmount}@{Checked.Count}@{Blank}", EntryColor, false, false); // <CENTER>Pen of Wisdom<br>(Mark Scrolls: ~1_VAL~, Runes: ~2_VAL~ | Selected: ~3_VAL~, Blank: ~4_VAL~)</CENTER>
