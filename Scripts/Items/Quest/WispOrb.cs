    ...
    public class WispOrb : Item
    {
                ...
                if (targeted is BaseCreature bc)
                {
                    ...
                    else if (m_Orb.Pet == null)
                    {
                        ...
                        else
                        {
                            ...
                            m_Orb.Pet.AddControlOrder(OrderType.Follow);
        ...
        public void TrySetAnchor(Mobile from, IPoint3D p)
        {
            ...
            if (p is Mobile m)
            {
                ...
                m_Pet.AddControlOrder(OrderType.Follow);
            }
        ...
        {
            return (int)m_Pet.GetDistanceToSqrt(GetAnchorLocation()) > m_Pet.GetLeashLength() + 1 && m_Pet.HasControlOrder(OrderType.Follow);
        }
