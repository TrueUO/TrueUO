...
namespace Server.Items
{
    ...
    public class BaseTalisman : Item, IWearableDurability, IVvVItem, IOwnerRestricted, ITalismanProtection, ITalismanKiller, IArtifact
    {
        ...
        private static readonly Type[] m_Killers =
        {
            ...
            typeof(DeathwatchBeetleHatchling), typeof(Bird), typeof(Chicken), typeof(Eagle),
            ...
            typeof(Cow), typeof(Bull), typeof(Gaman)
        };
        ...
        private static readonly int[] m_KillerLabels =
        {
            ...
            1072457, 1072458, 1072459, 1072461,
