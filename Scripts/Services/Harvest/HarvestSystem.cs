...
namespace Server.Engines.Harvest
{
    public abstract class HarvestSystem
    {
        ...
        public static bool TryHarvestGrave()
        {
            return false;
        }

        public static bool TryHarvestShrooms()
        {
            return false;
        }
...
namespace Server
{
    ...
    public class FurnitureAttribute : Attribute
    {
        ...
        private static readonly Type[] _NotChoppables =
        {
            ...
            typeof(FluffySpongeDeed), typeof(ShelfSpongeDeed), typeof(CactusSpongeDeed), typeof(BarrelSpongeDeed)
        };
