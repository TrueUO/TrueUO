...
namespace Server.Engines.Harvest
{
    public class Fishing : HarvestSystem
    {
        ...
        public override void SendSuccessTo(Mobile from, Item item, HarvestResource resource)
        {
            ...
            if (item is RedHerring) // You take the Red Herring and put it into your pack.  The only thing more surprising than the fact that there is a fish called the Red Herring is the fact that you fished for it!
            {
                from.SendLocalizedMessage(1095047, null, 0x23);
            }

            if (item is MudPuppy) // You take the Mud Puppy and put it into your pack.  Not surprisingly, it is very muddy.
            {
        ...
        public override bool BeginHarvesting(Mobile from, Item tool)
        {
            ...
            {
                from.SendLocalizedMessage(pole.HookType == HookType.Lava ? 1149623 : 500974);
            }
