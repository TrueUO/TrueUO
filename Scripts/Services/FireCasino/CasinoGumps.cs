    ...
    public class ChucklesLuckGump : BaseCasinoGump
    {
        ...
        public override void BuildResults()
        {
            ...
            else
            {
                ...
                AddHtmlLocalized(20, 250, 240, 32, 1153384, $"{matches}\t{win.ToString(CultureInfo.GetCultureInfo("en-US"))}", Yellow, false, false); // The dice matched your number ~1_COUNT~ times. You win ~2_AMT~ chips!
            }
