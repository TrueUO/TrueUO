...
namespace Server.Engines.Craft
{
    ...
    public class DefCarpentry : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            index = AddCraft(typeof(SmallElegantAquariumDeed), 1044290, 1156583, 100.0, 160.0, typeof(Board), 1044041, 20, 1044351);
            ...
            index = AddCraft(typeof(WallMountedAquariumDeed), 1044290, 1156583, 100.0, 160.0, typeof(Board), 1044041, 50, 1044351);
            ...
            index = AddCraft(typeof(LargeElegantAquariumDeed), 1044290, 1156583, 100.0, 160.0, typeof(Board), 1044041, 100, 1044351);
