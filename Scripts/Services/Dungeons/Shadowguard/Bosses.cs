...
namespace Server.Engines.Shadowguard
{
    public class ShadowguardBoss : BaseCreature
    {
        ...
        private readonly Type[] _ArtifactTypes =
        {
            ...
            typeof(HawkwindsRobe),          typeof(JumusSacredHide),
            typeof(JuonarsGrimoire),            typeof(UnstableTimeRift),
            typeof(MinaxsSandles),              typeof(MocapotlsObsidianSword), typeof(TotemOfTheTribe),
            typeof(BalakaisShamanStaffGargoyle)
        };
