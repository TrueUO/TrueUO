...
namespace Server.Items
{
    public class IversRoundingAddon : BaseAddon
    {
        ...
        private static readonly int[,] m_AddOnSimpleComponents = {
              {8600, 7, 7, 6}, {6057, 1, 6, 0}, {6057, 0, 6, 0}// 1	3	5	
			, {6057, -1, 6, 0}, {6060, 3, 5, 0}, {6057, 2, 5, 0}// 7	8	11	
			, {8778, 7, 3, 5}, {3329, 8, 2, 5}, {4970, 8, 1, 5}// 21	22	23	
			, {4970, 7, 1, 5}, {3480, 9, -3, 5}, {3280, 7, -3, 5}// 24	43	44	
			, {3277, 6, 4, 5}, {6059, 3, 4, 0}, {6058, 2, 4, 0}// 45	48	51	
			, {6059, 4, 3, 0}, {3293, 6, 2, 5}, {6059, 4, 2, 0}// 64	78	80	
			, {4970, 6, 1, 5}, {6059, 4, 1, 0}, {8611, -1, 1, 25}// 89	91	101	
			, {6059, 4, 0, 0}, {8611, 0, 0, 40}, {8611, -1, 0, 25}// 109	119	122	
			, {6059, 4, -1, 0}, {8611, 0, -1, 40}, {8611, -1, -1, 25}// 129	138	141	
			, {6059, 4, -2, 0}, {8611, 0, -2, 25}, {8611, -1, -2, 25}// 146	154	156	
			, {3329, 6, -3, 5}, {3326, 5, -3, 4}, {6059, 4, -3, 0}// 158	159	161	
			, {8611, 0, -3, 25}, {8611, -1, -3, 25}, {3293, 8, -4, 5}// 172	174	176	
			, {6059, 4, -4, 0}, {8611, -1, -4, 25}, {6059, 4, -5, 0}// 178	191	194	
			, {6057, -2, 6, 0}, {6057, -3, 6, 0}, {6057, -4, 6, 0}// 229	231	233	
			, {6057, -5, 6, 0}, {6057, -6, 6, 0}, {6057, -7, 6, 0}// 235	237	239	
			, {8611, -2, 2, 25}, {8611, -3, 2, 25}, {8611, -4, 2, 25}// 297	299	301	
			, {8611, -5, 2, 25}, {8611, -2, 1, 25}, {8611, -3, 1, 25}// 303	314	316	
			, {8611, -4, 1, 25}, {8611, -5, 1, 25}, {8611, -6, 1, 25}// 318	320	322	
			, {8611, -2, 0, 25}, {8611, -3, 0, 25}, {8611, -4, 0, 25}// 334	336	338	
			, {8611, -5, 0, 25}, {8611, -6, 0, 25}, {8611, -2, -1, 25}// 340	342	351	
			, {8611, -3, -1, 25}, {8611, -4, -1, 25}, {8611, -5, -1, 25}// 353	355	357	
			, {8611, -6, -1, 25}, {8611, -2, -2, 25}, {8611, -3, -2, 25}// 359	368	370	
			, {8611, -4, -2, 25}, {8611, -5, -2, 25}, {8611, -6, -2, 25}// 372	374	376	
			, {8611, -2, -3, 25}, {8611, -3, -3, 25}, {8611, -4, -3, 25}// 385	387	389	
			, {8611, -5, -3, 25}, {8611, -2, -4, 25}, {8611, -3, -4, 25}// 391	402	404	
			, {8611, -4, -4, 25}// 406	
		};
        ...
        public IversRoundingAddon()
        {
            ...
            AddComplexComponent(this, 471, 6, 0, 5, 1890, -1, "", 1);// 104
            AddComplexComponent(this, 1846, 5, 0, 30, 1890, -1, "", 1);// 105
