...
namespace Server.Misc
{
    ...
    */
    public static class PreventInaccess
    {
        ...
        private static readonly LocationInfo[] _Destinations = new LocationInfo[]
        {
        ...
        public static void OnLogin(Mobile from)
        {
            ...
            else if (_MoveHistory.TryGetValue(from, out LocationInfo value))
            {
                from.SendMessage($"Your character was moved from {value.Location} ({value.Map}) due to a detected client crash.");
