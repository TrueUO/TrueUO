        ...
        public override void AddGumpLayout()
        {
            ...
            if (menuCat == 1) // == CASTING ==
            {
                if (itemRef == 1 || itemRef == 2)
                {
                    ...
                    if (m_Item is BaseWeapon weapon && (weapon.Attributes.SpellChanneling == 0 || weapon.Attributes.CastSpeed < 0))
                    {
                ...
                else if (itemRef == 4)
                {
                    ...
                    if (m_Item is BaseShield shield && (shield.Attributes.SpellChanneling == 0 || shield.Attributes.CastSpeed < 0))
                    {
                        AddButton(250, 90 + yOffset * 20, 4005, 4007, 10116, GumpButtonType.Reply, 0);
                        AddHtmlLocalized(295, 90 + yOffset * 20, 150, 18, 1075617, LabelColor, false, false);       //Faster Casting
                    }
