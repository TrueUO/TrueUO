    ...
    public class XmlSpawner : Item, ISpawner
    {
        ...
        public void CheckTriggers(Mobile m, Skill s, bool hasproximity)
        {
            ...
            if (AllowTriggering && !m_proximityActivated)
            {
                ...
                //
                if (!string.IsNullOrEmpty(TriggerObjectProp))
                {
                ...
                if (!string.IsNullOrEmpty(MobTriggerProp) &&
                    !string.IsNullOrEmpty(MobTriggerName))
                {
                ...
                if (!string.IsNullOrEmpty(TriggerOnCarried))
                {
                ...
                if (!string.IsNullOrEmpty(NoTriggerOnCarried))
                {
