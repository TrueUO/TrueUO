...
namespace Server
{
    public static class MondainsLegacy
    {
        ...
        {
            typeof(BloodwoodSpirit), typeof(Boomstick), typeof(BrightsightLenses), typeof(QuiverOfRage),
            typeof(QuiverOfElements), typeof(SoulSeeker), typeof(TalonBite), typeof(TotemOfVoid)
        };
