...
namespace Server.Mobiles
{
    public class PersonalAttendant : BaseCreature
    {
        ...
        {
            AddControlOrder(OrderType.Stay);
            ControlTarget = null;
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            if (HasControlOrder(OrderType.Stay))
            {
        ...
        private class InternalTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                if (m_Attendant != null && !m_Attendant.Deleted)
                {
                    ...
                    if (m != null)
                    {
                        ...
                        else if (m_Attendant.HasControlOrder(OrderType.Follow) && !m.InRange(m_Attendant.Location, 12))
            ...
            private void CatchUp(object obj)
            {
                if (m_Attendant != null && !m_Attendant.Deleted)
                {
                    m_Attendant.AddControlOrder(OrderType.Follow);
