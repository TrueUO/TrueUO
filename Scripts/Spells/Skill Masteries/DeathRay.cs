            ...
            if (o is Mobile m)
            {
                ...
                else if (CheckHSequence(m))
                {
                    ...
                    else
                    {
                        ...
                        BuffInfo.AddBuff(Caster, new BuffInfo(BuffIcon.DeathRay, 1155896, 1156085, $"{(int) damage}\t{m.Name}")); // Deals ~2_DAMAGE~ to ~1_NAME~ every 3 seconds while in range. Preforming any action will end spell.
