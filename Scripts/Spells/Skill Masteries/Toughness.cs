    ...
    public class ToughnessSpell : SkillMasterySpell
    {
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                BuffInfo.AddBuff(Caster, new BuffInfo(BuffIcon.Toughness, 1155985, 1155986, $"{_HPBonus}\t{ScaleMana((int) UpKeep)}")); // Hit Point Increase: ~1_VAL~.<br>Mana Upkeep Cost: ~2_VAL~.
            }
