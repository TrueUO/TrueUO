    ...
    public class OnslaughtSpell : SkillMasteryMove
    {
        ...
        public override void OnHit(Mobile attacker, Mobile defender, int damage)
        {
            ...
            if (attacker.Weapon is BaseWeapon weapon && !HasOnslaught(attacker, defender))
            {
                ...
                BuffInfo.AddBuff(defender, new BuffInfo(BuffIcon.Onslaught, 1156009, 1156010, TimeSpan.FromSeconds(duration), defender, $"{amount}\t{resistType}")); // -~2_VAL~% ~1_RESIST~ Debuff.
