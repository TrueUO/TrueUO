    ...
    public class FocusedEyeSpell : SkillMasterySpell
    {
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                BuffInfo.AddBuff(Caster, new BuffInfo(BuffIcon.FocusedEye, 1156003, 1156004, $"{_PropertyBonus}\t{ScaleUpkeep()}")); // +~1_VAL~% Hit Chance Increase.<br>Mana Upkeep Cost: ~2_VAL~.
