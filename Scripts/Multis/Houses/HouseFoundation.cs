...
namespace Server.Multis
{
    ...
    public class HouseFoundation : BaseHouse
    {
        ...
        /// <summary>
        /// for EC, the details cache gets messed up when prior to MoveToWorld (null map).
    ...
    public class ConfirmCommitGump : Gump
    {
        ...
        public ConfirmCommitGump(HouseFoundation foundation, int bankBalance, int oldPrice, int newPrice)
            : base(50, 50)
        {
