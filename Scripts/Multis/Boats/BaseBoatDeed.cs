...
namespace Server.Multis
{
    public abstract class BaseBoatDeed : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else if (from.Region.IsPartOf(typeof(HouseRegion)) || boat != null && (boat.GetType() == Boat.GetType() || !boat.IsRowBoat && !(this is RowBoatDeed) || !boat.IsRowBoat && !(this is PumpkinRowBoatDeed)))
            {
